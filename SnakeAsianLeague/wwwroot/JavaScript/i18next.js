  ...
  await i18next.use(i18nextHttpBackend).init(
    {
      ...
      fallbackLng: defaultLang,
          ns: ["data", "Asian_data", "NFT_data", "Home_data", "ERNC_data", "Started_data", "Battle_data", "Inventory_data", "Company_data", "WarmUpActivities_data", "Cooperation_data","countryCode_data","NewYear2023_data","Arena_data" ],
      defaultNS: "data",
      backend: {
